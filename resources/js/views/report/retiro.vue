      ...
      <div class="card text-center">
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs">
            ...
            <li class="nav-item">
              <a class="nav-link  active" href="#">Retiro</a>
            </li>
            <li class="nav-item">
  ...
  methods: {
    ...
    setLink(event, el) {
      if (this.sd && this.ed && this.position) {
        el.href = `${this.$http.options.root}print/retiro/${this.sd}/${this.ed}/${this.position}/${this.currentRoom.id}`;
      } else {
    ...
    find() {
      this.$http.get(`operations/byDateRangeAndPosition/${this.sd}/${this.ed}/${this.position}/1/${this.currentRoom.id}`).then(response => {
        console.log(response);
